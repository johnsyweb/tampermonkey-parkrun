...
(function () {
  ...
  function detectEventGap(historyData) {
    ...
    console.log(
      'Detected '
        .concat(gaps.length, ' gap(s); using latest: ')
        .concat(latestGap.daysDiff.toFixed(1), ' days')
    );
  ...
  function getSeasonalWindow(referenceDate) {
    var weeksAround =
      arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : SEASONAL_WEEKS;
  ...
  function _fetchEventHistory() {
    _fetchEventHistory = _asyncToGenerator(
      /*#__PURE__*/ _regenerator().m(function _callee4(eventName, domain) {
        var CACHE_KEY,
            ...
            while (1)
              switch ((_context4.p = _context4.n)) {
                case 0:
                  ...
                  _context4.p = 2;
                  ((_JSON$parse2 = JSON.parse(cached)),
                  ...
                  console.log(
                    'Using cached history for '
                      .concat(eventName, ' (')
                      .concat(Math.round(age / 1000 / 60), ' minutes old)')
                  );
                ...
                case 4:
                  ...
                  _t5 = _context4.v;
                  console.log(
                    'Cache parse error for '.concat(eventName, ', fetching fresh data'),
                    _t5
                  );
                case 5:
                  // Fetch from network
  ...
  function calculateBaseline(data) {
    ...
    var avgFinishers = Math.round(
      data.finishers.reduce(function (a, b) {
        return a + b;
      }, 0) / data.dates.length
    );
    var avgVolunteers = Math.round(
      data.volunteers.reduce(function (a, b) {
        return a + b;
      }, 0) / data.dates.length
    );
    return {
  ...
  function renderCancellationSummary(eventShortName) {
    ...
    eventNameDiv.innerHTML = '<strong style="color: '
      .concat(STYLES.lineColor, ';">')
      .concat(eventShortName, '</strong>');
  ...
  function _renderCancellationAnalysis() {
    _renderCancellationAnalysis = _asyncToGenerator(
            ...
            switch (_context5.n) {
              ...
              case 4:
                ...
                eventShortName =
                  ...
                  (_currentParkrun$prope2 = currentParkrun.properties) === null ||
                  _currentParkrun$prope2 === void 0
                    ? void 0
                    : _currentParkrun$prope2.EventShortName) || null; // Cancellation summary with start button
                ((_renderCancellationSu = renderCancellationSummary(eventShortName)),
                  (summarySection = _renderCancellationSu.section),
                  (startButton = _renderCancellationSu.startButton));
  ...
  function _startBackgroundAnalysis() {
    _startBackgroundAnalysis = _asyncToGenerator(
      /*#__PURE__*/ _regenerator().m(function _callee6(progressUI, container, summarySection) {
        var eventInfo,
          nearbyParkruns,
          allGaps,
              ...
              switch ((_context6.p = _context6.n)) {
                case 0:
                  ...
                  allGaps.forEach(function (gap) {
                    ...
                    cancellationSaturdays.push.apply(
                      cancellationSaturdays,
                      _toConsumableArray(saturdays)
                    );
                  });
                ...
                case 2:
                  ...
                  progressUI.updateStatus(
                    'Fetching: '.concat(shortName, ' (').concat(distance, 'km)')
                  );
                ...
                case 8:
                  ...
                  cancellationSaturdays.forEach(function (targetDate) {
                    ...
                    nearbyHistories.forEach(function (_ref3) {
                      ...
                      var beforeData = filterEventsByDateRange(
                        historyData,
                        windowBefore.start,
                        windowBefore.end
                      );
                          ...
                          ? {
                              ...
                              finishersPct:
                                baseline.avgFinishers > 0
                                  ? ((eventOnDate.finishers - baseline.avgFinishers) /
                                      baseline.avgFinishers) *
                                    100
                                  : 0,
                              volunteersPct:
                                baseline.avgVolunteers > 0
                                  ? ((eventOnDate.volunteers - baseline.avgVolunteers) /
                    ...
                    if (eventsHeld >= 1) {
                      ...
                      console.log(
                        'Skipping '
                          .concat(dateKey, ': 0/')
                          .concat(results.length, ' parkruns ran (global cancellation)')
                      );
                    }
                  });
                  ...
                  finalCancellationDates =
                    validCancellationDates.length > 0
                      ? validCancellationDates
                      : cancellationSaturdays;
                ...
                case 9:
                  progressUI.updateStatus(
                    'Analysis complete! Found '.concat(
                      validCancellationDates.length,
                      ' valid cancellation date(s)'
                    )
                  );
                  ...
                  navSection = createNavigationControls(
                    container,
                    resultsByDate,
                    finalCancellationDates,
  ...
  function createNavigationControls(container, resultsByDate, cancellationDates, currentDateIndex) {
    ...
    navInfo.innerHTML = '\n      <strong>'
      .concat(cancellationDates.length, ' Cancellation Date')
      .concat(
        cancellationDates.length !== 1 ? 's' : '',
        ' Available</strong>\n      <div style="color: '
      )
      .concat(
        STYLES.subtleTextColor,
        '; font-size: 12px; margin-top: 4px;">\n        Use dropdown or buttons to navigate \u2022 Keyboard: <kbd style="background: #3a3250; padding: 2px 6px; border-radius: 3px; font-family: monospace; border: 1px solid '
      )
      .concat(
        STYLES.gridColor,
        ';">\u2190</kbd> <kbd style="background: #3a3250; padding: 2px 6px; border-radius: 3px; font-family: monospace; border: 1px solid '
      )
      .concat(STYLES.gridColor, ';">\u2192</kbd>\n      </div>\n    ');
  ...
  function _buildHtmlReport() {
    _buildHtmlReport = _asyncToGenerator(
      /*#__PURE__*/ _regenerator().m(function _callee7(resultsSection, meta) {
              ...
              case 0:
                ...
                header =
                  '\n      <header>\n        <h1>parkrun Cancellation Impact</h1>\n        <div class="meta">\n          <div><strong>Event:</strong> '
                    .concat(
                      meta.eventShortName,
                      '</div>\n          <div><strong>Cancelled date:</strong> '
                    )
                    .concat(
                      meta.cancellationDateStr,
                      '</div>\n          <div><strong>Generated:</strong> '
                    )
                    .concat(meta.generatedAt, '</div>\n        </div>\n      </header>\n    ');
                return _context7.a(
                  2,
                  '<!DOCTYPE html><html><head><meta charset="UTF-8"><title>parkrun Cancellation Impact - '
                    .concat(meta.eventShortName, ' - ')
                    .concat(meta.cancellationDateStr, '</title><style>')
  ...
  function _generateReportBlob() {
    _generateReportBlob = _asyncToGenerator(
      /*#__PURE__*/ _regenerator().m(function _callee8(resultsSection, meta) {
        var html, filename;
        return _regenerator().w(function (_context8) {
          while (1)
            switch (_context8.n) {
              ...
              case 1:
                html = _context8.v;
                filename = 'parkrun-cancellation-impact-'
                  .concat(meta.eventShortName, '-')
                  .concat(meta.cancellationDateStr, '.html');
  ...
  function renderImpactResults(
    ...
    var headers = [
      ...
      },
      {
        ...
        key: 'baseline',
        align: 'right',
        info: '12-week seasonal average (finishers/volunteers) ending the day before '.concat(
          dateStr,
          '.'
        ),
      },
    ...
    var renderTable = function renderTable(sortedResults) {
      ...
      sortedResults.forEach(function (result) {
        ...
        link.href = ''
          .concat(getCurrentEventInfo().url, '/')
          .concat(result.eventName, '/results/eventhistory/');
        ...
        baselineCell.innerHTML = '<strong>'
          .concat(result.baseline.avgFinishers, '</strong> / ')
          .concat(result.baseline.avgVolunteers);
        ...
        if (result.eventOnDate) {
          onDateCell.innerHTML = '<strong>'
            .concat(result.eventOnDate.finishers, '</strong> / ')
            .concat(result.eventOnDate.volunteers);
        } else {
        ...
        if (result.change) {
          ...
          changeCell.innerHTML = '\n          <span style="color: '
            .concat(finishersColor, ';">')
            .concat(finishersSign)
            .concat(result.change.finishersChange, '</span> /\n          <span style="color: ')
            .concat(volunteersColor, ';">')
            .concat(volunteersSign)
            .concat(result.change.volunteersChange, '</span>\n        ');
        } else {
        ...
        if (result.change) {
          ...
          changePctCell.innerHTML = '<span style="color: '
            .concat(pctColor, ';">')
            .concat(sign)
            .concat(result.change.finishersPct.toFixed(1), '%</span>');
        } else {
    ...
    windowText.innerHTML = 'Window: '
      .concat(startStr, ' \u2192 ')
      .concat(endStr, ' (12-week baseline)');
    ...
    trendStats.innerHTML = '\n      <div>Average finishers: <strong>'
      .concat(
        seasonalTrend.baseline.avgFinishers,
        '</strong></div>\n      <div>Min finishers: <strong>'
      )
      .concat(
        seasonalTrend.baseline.minFinishers,
        '</strong></div>\n      <div>Max finishers: <strong>'
      )
      .concat(
        seasonalTrend.baseline.maxFinishers,
        '</strong></div>\n      <div>Average volunteers: <strong>'
      )
      .concat(
        seasonalTrend.baseline.avgVolunteers,
        '</strong></div>\n      <div>Min volunteers: <strong>'
      )
      .concat(
        seasonalTrend.baseline.minVolunteers,
        '</strong></div>\n      <div>Max volunteers: <strong>'
      )
      .concat(
        seasonalTrend.baseline.maxVolunteers,
        '</strong></div>\n      <div>Total events: <strong>'
      )
      .concat(seasonalTrend.baseline.totalEvents, '</strong></div>\n    ');
    ...
    var topAbsolute = _toConsumableArray(positiveChanges)
      .sort(function (a, b) {
        return b.change.finishersChange - a.change.finishersChange;
      })
      .slice(0, 1);
    var topRelative = _toConsumableArray(positiveChanges)
      .filter(function (r) {
    ...
    if (topAbsolute.length === 0) {
      ...
      if (topAbsolute[0]) {
        var r = topAbsolute[0];
        summaries.push(
          'Largest absolute gain: <strong>'
            .concat(r.displayName || r.eventName, '</strong> (+')
            .concat(r.change.finishersChange, ' finishers, ')
            .concat(r.change.finishersPct.toFixed(1), '%)')
        );
      }
      if (topRelative[0]) {
        var _r = topRelative[0];
        summaries.push(
          'Largest relative gain: <strong>'
            .concat(_r.displayName || _r.eventName, '</strong> (+')
            .concat(_r.change.finishersPct.toFixed(1), '%, +')
            .concat(_r.change.finishersChange, ' finishers)')
        );
      }
      ...
      impactedList.forEach(function (r) {
        ...
        stats.style.gap = '6px';
        stats.innerHTML = '\n          <div>Avg finishers: <strong>'
          .concat(
            r.seasonalTrend.baseline.avgFinishers,
            '</strong></div>\n          <div>Min finishers: <strong>'
          )
          .concat(
            r.seasonalTrend.baseline.minFinishers,
            '</strong></div>\n          <div>Max finishers: <strong>'
          )
          .concat(
            r.seasonalTrend.baseline.maxFinishers,
            '</strong></div>\n          <div>Avg volunteers: <strong>'
          )
          .concat(
            r.seasonalTrend.baseline.avgVolunteers,
            '</strong></div>\n          <div>Min volunteers: <strong>'
          )
          .concat(
            r.seasonalTrend.baseline.minVolunteers,
            '</strong></div>\n          <div>Max volunteers: <strong>'
          )
          .concat(r.seasonalTrend.baseline.maxVolunteers, '</strong></div>\n        ');
    ...
    if (typeof Chart !== 'undefined') {
      ...
      var volunteersBaseline = results
        .filter(function (r) {
          return r.eventOnDate;
        })
        .map(function (r) {
    ...
    var avgChangeFinishers =
      eventsWithData.length > 0 ? Math.round(totalGain / eventsWithData.length) : 0;
    var avgChangeVolunteers =
      eventsWithData.length > 0
        ? Math.round(
            eventsWithData.reduce(function (sum, r) {
              return sum + r.change.volunteersChange;
            }, 0) / eventsWithData.length
          )
        : 0;
    ...
    summaryText.innerHTML = '\n      <p style="margin: 4px 0;">\n        <strong>'
      .concat(results.length, '</strong> nearby parkruns analyzed\n        <span style="color: ')
      .concat(
        STYLES.subtleTextColor,
        '; font-size: 11px; margin-left: 8px;" title="parkruns within 50km of the cancelled event in the same country and series">\u2139</span>\n      </p>\n      <p style="margin: 4px 0;">\n        <strong>'
      )
      .concat(eventsWithData.length, '</strong> held events on ')
      .concat(dateStr, '\n        <span style="color: ')
      .concat(
        STYLES.subtleTextColor,
        '; font-size: 11px; margin-left: 8px;" title="Number of nearby parkruns that ran on this date">\u2139</span>\n      </p>\n      <p style="margin: 4px 0;">\n        Average change in finishers: <span style="color: '
      )
      .concat(
        avgChangeFinishers < 0 ? STYLES.alertColor : STYLES.successColor,
        '; font-weight: bold;">'
      )
      .concat(avgChangeFinishers > 0 ? '+' : '')
      .concat(avgChangeFinishers, '</span>\n        <span style="color: ')
      .concat(
        STYLES.subtleTextColor,
        '; font-size: 11px; margin-left: 8px;" title="Mean difference between actual finishers and 12-week baseline average across events that ran">\u2139</span>\n      </p>\n      <p style="margin: 4px 0;">\n        Average change in volunteers: <span style="color: '
      )
      .concat(
        avgChangeVolunteers < 0 ? STYLES.alertColor : STYLES.successColor,
        '; font-weight: bold;">'
      )
      .concat(avgChangeVolunteers > 0 ? '+' : '')
      .concat(avgChangeVolunteers, '</span>\n        <span style="color: ')
      .concat(
        STYLES.subtleTextColor,
        '; font-size: 11px; margin-left: 8px;" title="Mean difference between actual volunteers and 12-week baseline average across events that ran">\u2139</span>\n      </p>\n      <p style="margin: 4px 0;">\n        Estimated total additional finishers: <span style="color: '
      )
      .concat(totalGain < 0 ? STYLES.alertColor : STYLES.successColor, '; font-weight: bold;">')
      .concat(totalGain > 0 ? '+' : '')
      .concat(totalGain, '</span>\n        <span style="color: ')
      .concat(
        STYLES.subtleTextColor,
        '; font-size: 11px; margin-left: 8px;" title="Sum of all finisher changes across nearby parkruns - positive indicates runners redistributed from the cancelled event">\u2139</span>\n      </p>\n      <p style="margin: 4px 0;">\n        Estimated total additional volunteers: <span style="color: '
      )
      .concat(
        totalVolunteerGain < 0 ? STYLES.alertColor : STYLES.successColor,
        '; font-weight: bold;">'
      )
      .concat(totalVolunteerGain > 0 ? '+' : '')
      .concat(totalVolunteerGain, '</span>\n        <span style="color: ')
      .concat(
        STYLES.subtleTextColor,
        '; font-size: 11px; margin-left: 8px;" title="Sum of all volunteer changes across nearby parkruns - indicates how many extra volunteers were needed on the day">\u2139</span>\n      </p>\n    '
      );
              ...
              while (1)
                switch ((_context.p = _context.n)) {
                  case 0:
                    ...
                    _context.p = 1;
                    ((_getReportMeta = getReportMeta()),
                      (eventShortName = _getReportMeta.eventShortName),
                      (cancellationDateStr = _getReportMeta.cancellationDateStr));
                    _context.n = 2;
              ...
              while (1)
                switch ((_context2.p = _context2.n)) {
                  case 0:
                    ...
                    _context2.p = 1;
                    ((_getReportMeta2 = getReportMeta()),
                      (eventShortName = _getReportMeta2.eventShortName),
                      (cancellationDateStr = _getReportMeta2.cancellationDateStr));
                    _context2.n = 2;
                    return generateReportBlob(resultsSection, {
                      eventShortName: eventShortName,
                      cancellationDateStr: cancellationDateStr,
