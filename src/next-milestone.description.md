parkrun Next Milestone Estimate adds expected dates to a parkrunner profile so you can see when they are likely to reach their next finisher and volunteer milestones.
...
Volunteer credits from the Volunteer Summary are shown under the profile heading, with an estimate for the next volunteer milestone on the same ladder as 5k finishers.
