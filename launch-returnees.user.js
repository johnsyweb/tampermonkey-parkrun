...
_asyncToGenerator(
  /*#__PURE__*/ _regenerator().m(function _callee3() {
    ...
    var STYLES,
      ...
      _fetchEventParticipants,
      insertAfterTitle,
      createHeader,
      createNoReturneesMessage,
      createReturneeListItem,
      createReturneesList,
      createContainer,
      displayReturnees,
      init,
      ...
      while (1)
        switch (_context3.n) {
          case 0:
                    ...
                    while (1)
                      switch (_context2.n) {
                        ...
                        case 1:
                          ...
                          returnees = _toConsumableArray(currentParticipants.keys()).filter(
                            function (id) {
            ...
            displayReturnees = function _displayReturnees(
              returnees,
              currentParticipants,
              launchParticipants,
              origin
            ...
            createReturneesList = function _createReturneesList(
              returnees,
              currentParticipants,
              launchParticipants,
              origin
              ...
              returnees.forEach(function (id) {
                var listItem = createReturneeListItem(
                  id,
                  currentParticipants,
                  launchParticipants,
                  origin
            ...
            createReturneeListItem = function _createReturneeListIt(
              id,
              currentParticipants,
              launchParticipants,
              origin
              ...
              link.target = '_blank';
              var name =
                currentParticipants.get(id) || launchParticipants.get(id) || 'Unknown parkrunner';
            ...
            _fetchEventParticipants = function _fetchEventParticipan2() {
              _fetchEventParticipants = _asyncToGenerator(
                /*#__PURE__*/ _regenerator().m(function _callee(url) {
                  var cacheKey,
                    cachedData,
                    _JSON$parse,
                    data,
                      ...
                      while (1)
                        switch ((_context.p = _context.n)) {
                          case 0:
                            ...
                            ((_JSON$parse = JSON.parse(cachedData)),
